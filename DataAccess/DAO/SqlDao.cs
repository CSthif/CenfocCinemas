...
namespace DataAccess.DAOs
{
    public class SqlDao
    {
        ...
        private SqlDao()
        {
            _connectionString = @"Data Source=server-cenfocinemas-sqldatabase.database.windows.net;Initial Catalog=CenfoCinemasDb;User ID=Cenfocinemas;Password=Admin123";
        }
